"""
Fill inventory_sku in an Amazon FBA opening-stock CSV by matching ASIN to
platform_listing.external_ref_id for Platform.AMAZON.

Example:
    python scripts/fba_opening_stock_inventory_sku_match.py \
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fill inventory_sku in FBA opening-stock CSV from platform listings.",
    )
    parser.add_argument(
        "--input",
        required=True,
